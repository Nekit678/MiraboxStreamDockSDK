...
добавляет маршрутизирующие метаданные, но payload остаётся скрытым на всех
уровнях. Handlers, установленные приложением вручную, остаются его ответственностью.
